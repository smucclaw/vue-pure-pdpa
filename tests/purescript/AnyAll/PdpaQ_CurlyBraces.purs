            ...
            { andOr: And, children: [(Q 
                { andOr: And, children: [(Q 
                    ...
                    { andOr: Or, children: [(Q 
                        ...
                        })], mark: (Default (Left Nothing)), prePost: (Just (Pre "5 Any information that identifies, or is likely to lead to the identification of, the individual as a child or young person who —")), shouldView: View, tagNL: (fromFoldable []) 
                        }),(Q 
                        { andOr: Or, children: [(Q 
                        ...
                        })], mark: (Default (Left Nothing)), prePost: (Just (Pre "6 Any information that identifies, or is likely to lead to the identification of — b")), shouldView: View, tagNL: (fromFoldable []) 
                        }),(Q 
                        { andOr: Or, children: [(Q 
                        ...
                        })], mark: (Default (Left Nothing)), prePost: (Just (Pre "7 Any private key of or relating to the individual that is used or may be used —")), shouldView: View, tagNL: (fromFoldable []) 
                        }),(Q 
                        ...
                        { andOr: (Simply "15 The individual’s investment in any capital markets products."), children: [], mark: (Default (Left Nothing)), prePost: Nothing, shouldView: Ask, tagNL: (fromFoldable []) 
                        }),(Q 
                        { andOr: Or, children: [(Q 
                        ...
                        })], mark: (Default (Left Nothing)), prePost: (Just (Pre "16 The existence, and amount due or outstanding, of any debt —")), shouldView: View, tagNL: (fromFoldable []) 
                        }),(Q 
                        { andOr: Or, children: [(Q 
                        ...
                        })], mark: (Default (Left Nothing)), prePost: (Just (Pre "19 The provision of treatment to the individual for or in respect of —")), shouldView: View, tagNL: (fromFoldable []) 
                        }),(Q 
                        { andOr: Or, children: [(Q 
